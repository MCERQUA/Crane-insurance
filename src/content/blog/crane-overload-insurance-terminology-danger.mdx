...
These real-world examples expose a critical and dangerous gap between insurance terminology and crane operation reality. This misunderstanding isn't just about paperwork—it's creating coverage gaps that could leave operators financially devastated when accidents occur.
...
4. **Rigging weight calculations** - Inclusion of all below-the-hook attachments
...
**These safety factors are not "extra capacity"—they're essential margins that prevent catastrophic failures.**
...
**Industry standards require capacity reductions starting at 20 mph sustained winds, with complete shutdown typically required at 35-39 mph.**
...
The National Commission for the Certification of Crane Operators (NCCCO) requires:
...
**OSHA Subpart CC (29 CFR 1926.1400-1442) requires**:
...
**Industry standards like ASME B30.5 provide additional requirements** for:
...
According to industry data and OSHA incident reports:
...
**Notice that "exceeding nameplate capacity" rarely appears as a primary cause**, because experienced operators know better than to attempt obvious overloads.
...
- OSHA requirements for crane operations
- NCCCO certification standards
- ASME and API industry guidelines
...
- Industry safety guidelines and standards
...
3. **Notify authorities** - OSHA, insurance company, and relevant regulatory bodies
